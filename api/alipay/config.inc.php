...
$service_type = isset($PAY[$bank]['service']) ? $PAY[$bank]['service'] : 'create_direct_pay_by_user';//交易类型，必填实物交易＝trade_create_by_buyer（需要填写物流） 虚拟物品交易＝create_digital_goods_trade_p
