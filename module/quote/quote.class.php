...
class quote {
    ...
    function quote($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','pid','level','title','style','fee','introduce','thumb','tag','status','username','addtime','adddate', 'editor','edittime','ip','template', 'linkurl','filepath','note');
    }
