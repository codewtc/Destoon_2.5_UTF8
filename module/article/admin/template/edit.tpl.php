...
<td><input name="post[title]" type="text" id="title" size="60" value="<?php echo $title;?>"/> <?php echo level_select('post[level]', '级别', $level);?> <?php echo dstyle('post[style]', $style);?>&nbsp;&nbsp;<input type="button" value="标题检测" onclick="check_title();" class="btn"/><br/><span id="dtitle" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">标题图片</td>
...
<a href="javascript:pagebreak();" class="t">[插入分页符]</a>
</td>
