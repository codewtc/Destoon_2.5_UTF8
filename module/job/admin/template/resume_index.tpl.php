...
&nbsp;
薪资：
<span title="期望薪资"><input name="minsalary" type="text" id="minsalary" size="5" value="<?php echo $minsalary;?>"/> 至 <input name="maxsalary" type="text" id="maxsalary" size="5" value="<?php echo $maxsalary;?>"/> 元/月</span>
...
<td align="left"><a href="<?php echo $v['linkurl'];?>" target="_blank"><?php echo $v['truename'];?>(<?php echo $v['gender'] == 1 ? '男' : '女';?>)</a><?php if($v['thumb']) {?> <a href="javascript:_preview('<?php echo $v['thumb'];?>');"><img src="<?php echo IMG_PATH;?>img.gif" width="10" height="10" title="免冠照片,点击预览" alt=""/></a><?php } ?></td>
...
<input type="submit" value=" 移动简历 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=move';"/>&nbsp;
