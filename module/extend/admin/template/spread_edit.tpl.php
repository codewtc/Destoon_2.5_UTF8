...
<td>
<input type="radio" name="post[currency]" value="3" <?php if($currency == 'money') echo 'checked';?>/> 资金
<input type="radio" name="post[currency]" value="2" <?php if($currency == 'credit') echo 'checked';?>/> 积分
</td>
</tr>
<tr>
<td class="tl">信息ID <span class="f_red">*</span></td>
<td><input type="text" size="20" name="post[tid]" id="tid" value="<?php echo $tid;?>"/> <span id="dtid" class="f_red"></span></td>
</tr>
<tr>
