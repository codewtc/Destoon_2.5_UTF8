...
<td>
<input type="radio" name="setting[spread_currency]" value="money"  <?php if($spread_currency == 'money') echo 'checked';?>/> 资金&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[spread_currency]" value="credit"  <?php if($spread_currency == 'credit') echo 'checked';?>/> 积分
</td>
</tr>
</table>
...
<td>
<input type="radio" name="setting[ad_currency]" value="money"  <?php if($ad_currency == 'money') echo 'checked';?>/> 资金&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[ad_currency]" value="credit"  <?php if($ad_currency == 'credit') echo 'checked';?>/> 积分
</td>
</tr>
</table>
...
<td><a href="<?php echo DT_URL.'sitemaps.xml';?>" target="_blank"><?php echo DT_URL.'sitemaps.xml';?></a>&nbsp;&nbsp; <a href="?moduleid=<?php echo $moduleid;?>&file=sitemap&action=sitemaps" class="t">立即更新</a></td>
</tr>
<tr>
...
<tr>
<td class="tl">URL地址</td>
<td><a href="<?php echo DT_URL.'baidunews.xml';?>" target="_blank"><?php echo DT_URL.'baidunews.xml';?></a>&nbsp;&nbsp; <a href="?moduleid=<?php echo $moduleid;?>&file=sitemap&action=baidunews" class="t">立即更新</a></td>
</tr>
<tr>
