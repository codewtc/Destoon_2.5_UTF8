...
<td class="px11"><?php echo $v['fromdate'];?>~<?php echo $v['todate'];?></td>
...
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&itemid=<?php echo $v['itemid'];?>"><img src="<?php echo IMG_PATH;?>child.png" width="16" height="16" title="投票记录" alt=""/></a>&nbsp;
