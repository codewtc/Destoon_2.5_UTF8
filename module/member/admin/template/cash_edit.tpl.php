...
<tr>
<td class="tl">MSN</td>
<td><a href="msnim:chat?contact=<?php echo $member['msn'];?>"><img src="<?php echo SKIN_PATH;?>image/msnchat.gif" width="25" height="17" title="点击MSN交谈/留言" alt=""/></a> <?php echo $member['msn'];?></td>
</tr>
<?php } ?>
<tr>
<td class="tl">申请时间</td>
