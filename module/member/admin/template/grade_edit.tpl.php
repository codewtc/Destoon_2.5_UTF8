...
<tr>
<td class="tl">优惠幅度</td>
<td class="f_blue"><?php echo $promo_amount;?> <?php echo $promo_type ? '天' : '元';?></td>
</tr>
<?php } ?>
<tr>
<td class="tl">申请时间</td>
...
<?php if($user && $fee) { ?>
<tr>
<td class="tl">会员组年费</td>
<td class="f_b f_red"><?php echo $fee;?> 元</td>
</tr>
...
<tr>
<td class="tl">优惠幅度</td>
<td class="f_blue"><?php echo $promo_amount;?> 元</td>
</tr>
<?php } ?>
<tr>
<td class="tl">会员已支付</td>
<td class="f_blue"><?php echo $amount;?> 元</td>
</tr>
<tr>
<td class="tl">需支付金额</td>
<td class="f_blue"><input type="text" name="post[pay]" size="5" value="<?php echo $pay;?>"/> 元&nbsp;&nbsp;&nbsp;<a href="?moduleid=2&file=record&action=add&username=<?php echo $username;?>" class="t" target="_blank">[资金管理]</a>&nbsp;&nbsp;<span class="f_gray">(会员当前账户余额:<?php echo $user['money'];?>元)</span></td>
</tr>
<tr>
...
function S(i) {
	if(i==1) {
		Dh('pass');Ds('send');
		try{$('content').value=$('c_1').value;}catch(e){}
	} else if(i==2) {
		Dh('pass');Dh('send');
	} else if(i==3) {
		Ds('pass');Ds('send');
		try{$('content').value=$('c_3').value;}catch(e){}
	}
}
</script>
