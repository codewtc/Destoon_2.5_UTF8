...
<tr onmouseover="this.className='on';" onmouseout="this.className='';" align="center" title="添加时间:<?php echo $v['adddate'];?>">
<td><input type="checkbox" name="itemid[]" value="<?php echo $v['itemid'];?>"/></td>
<td><input name="listorder[<?php echo $v['itemid'];?>]" type="text" size="1" value="<?php echo $v['listorder'];?>"/></td>
<td style="padding:10px 0 10px 0;"><img src="<?php echo $v['thumb'];?>"/></td>
