...
<td><input name="post[skin]" type="text" size="30" value="<?php echo $skin;?>" /> <?php tips('请上传目录至 ./skin/'.$CFG['skin'].'/homepage/<br/>名称为数字、字母组合');?> <span id="dskin" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">模板目录 <span class="f_red">*</span></td>
<td><input name="post[template]" type="text" size="30" value="<?php echo $template;?>" /><?php tips('请上传目录至 ./template/'.$CFG['template'].'/<br/>名称为数字、字母组合');?> <span id="dtemplate" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">模板作者</td>
