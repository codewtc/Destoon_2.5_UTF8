...
<td><a href="<?php echo userurl($v['username'], 'file=credit&itemid='.$v['itemid']);?>" target="_blank"><?php echo $v['title'];?></a></td>
...
<div class="btns">
<input type="submit" value=" 更新地址 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=update';"/>&nbsp;
