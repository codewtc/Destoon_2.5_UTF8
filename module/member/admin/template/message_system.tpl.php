...
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=_delete&itemid=<?php echo $v['itemid'];?>" onclick="return _delete();"><img src="<?php echo IMG_PATH;?>delete.png" width="16" height="16" title="删除" alt=""/></a>
</td>
</tr>
<?php }?>
</table>
