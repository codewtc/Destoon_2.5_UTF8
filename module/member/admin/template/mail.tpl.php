...
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=send&itemid=<?php echo $v['itemid'];?>"><img src="<?php echo IMG_PATH;?>child.png" width="16" height="16" title="发送邮件" alt=""/></a>
