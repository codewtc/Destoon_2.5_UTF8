...
天的信息 <input type="submit" value="删 除" class="btn" onclick="if($('days').value==''){alert('请填写天数');return false;}if(confirm('确定要删除过期'+$('days').value+'天的证书信息吗？此操作将不可撤销')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=expire&refresh=1&delete=1'}else{return false;}"/></span>
