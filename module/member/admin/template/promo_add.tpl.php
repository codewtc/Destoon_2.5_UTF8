...
<tr>
<td class="tl">优惠码组成 <span class="f_red">*</span></td>
...
<tr>
<td class="tl">优惠码长度 <span class="f_red">*</span></td>
...
<tr>
<td class="tl">优惠类型 <span class="f_red">*</span></td>
<td>
<input type="radio" name="type" value="0" id="t_0" onclick="$('am').innerHTML='元';" checked/><label for="t_0"> 抵金额</label>&nbsp;&nbsp;
<input type="radio" name="type" value="1" id="t_1" onclick="$('am').innerHTML='天 <span class=f_gray>自使用时间开始计算</span>';"/><label for="t_1"> 有效期</label>
</tr>
<tr>
<td class="tl">优惠额度 <span class="f_red">*</span></td>
<td><input name="amount" id="amount" type="text" size="5" value="30"/> <span id="am">元</span></td>
</tr>
<tr>
