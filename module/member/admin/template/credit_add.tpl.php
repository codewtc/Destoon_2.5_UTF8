...
<td>
	...
	<td width="120"><img src="<?php echo SKIN_PATH;?>image/waitpic.gif" id="showthumb" title="预览图片" alt="" onclick="if(this.src.indexOf('waitpic.gif') == -1){_preview($('showthumb').src, 1);}else{Dalbum('',<?php echo $moduleid;?>,100, 100, $('thumb').value, true);}"/></td>
	</tr>
