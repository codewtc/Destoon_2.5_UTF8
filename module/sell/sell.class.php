...
class sell {
    ...
    function sell($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','mycatid','areaid','typeid','pid','level','title','style','fee','introduce','model','standard','brand','unit','price','minamount','amount','days','thumb','thumb1','thumb2','tag','status','username','totime','editor','addtime','adddate','edittime','editdate','ip','template','linkurl','filepath','elite','note','company','truename','telephone','mobile','address','email','msn','qq');
    }
