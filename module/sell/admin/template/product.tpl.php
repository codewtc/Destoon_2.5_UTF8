...
<td>
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&pid=<?php echo $v['pid'];?>&action=add"><img src="<?php echo IMG_PATH;?>new.png" width="16" height="16" title="添加属性" alt=""/></a>&nbsp;
<a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&pid=<?php echo $v['pid'];?>&action=manage"><img src="<?php echo IMG_PATH;?>child.png" width="16" height="16" title="管理属性" alt=""/></a>&nbsp;
</td>
</tr>
<?php } ?>
<tr onmouseover="this.className='on';" onmouseout="this.className='';" align="center">
