...
<td align="left"><a href="<?php echo $v['linkurl'];?>" target="_blank"><?php echo $v['title'];?></a><?php if($v['thumb']) {?> <a href="javascript:_preview('<?php echo $v['thumb'];?>');"><img src="<?php echo IMG_PATH;?>img.gif" width="10" height="10" title="标题图,点击预览" alt=""/></a><?php } ?><?php if($v['vip']) {?> <img src="<?php echo SKIN_PATH;?>image/vip.gif" title="<?php echo VIP;?>:<?php echo $v['vip'];?>"/><?php } ?>
</td>
<td><?php echo $v['price'] ? $v['price'] : '';?><?php echo $v['unit'] ? '元/'.$v['unit'] : '';?></td>
<td>
<?php if($v['username']) { ?>
