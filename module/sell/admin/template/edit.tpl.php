...
<td><input name="post[tag]" id="tag" type="text" size="30" value="<?php echo $tag;?>"/> <input type="button" value="分类建议" onclick="reccate(<?php echo $moduleid;?>, 'tag');" class="btn"/> <span id="dtag" class="f_red"></span></td>
</tr>
<tr>
...
<td>
	...
	<tr>
	<td>产品单价</td>
	<td><input name="post[price]" type="text" size="10" value="<?php echo $price;?>"/> 元/<span id="u1"><?php echo $unit ? $unit : '单位';?></span></td>
	</tr>
	<tr>
	<td>最小起订量</td>
