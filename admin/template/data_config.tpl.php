...
<tr>
<td class="tl">配置名称 <span class="f_red">*</span></td>
<td class="f_gray">
...
<input type="radio" name="data[database]" value="mssql" id="d_1" <?php echo $database == 'mssql' ? 'checked' : '';?>/><label for="d_1"/> MSSQL</label>&nbsp;&nbsp;&nbsp;
...
<tr>
<td class="tl">主键字段 <span class="f_red">*</span></td>
<td class="f_gray">
...
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl" align="center">对应说明</td>
...
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">PHP代码</td>
<td class="f_gray"><textarea name="code" id="code" style="width:98%;height:60px;overflow:visible;font-family:Fixedsys,verdana;"><?php echo $code;?></textarea><br/>
- 代码将在源数据循环读出时执行，源数据保存在 $F 数组，对应转换结果保存在 $T 数组<br/>
- 系统将保存PHP代码至 file/data/配置名称.inc.php。如果共享配置，请包含此文件打包<br/>
</td>
</tr>
<tr>
<td class="tl"> </td>
...
function check() {
	...
	if($('db_table').value.length < 1) {
		alert('请填写数据表');
		$('db_table').focus();
		return false;
	}
	if($('db_key').value.length < 1) {
		alert('请填写主键字段');
		$('db_key').focus();
		return false;
	}
