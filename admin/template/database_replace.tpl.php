...
<tr>
<td class="tl">文件名前缀 <span class="f_red">*</span></td>
<td>
<input type="text" name="file_pre" value="" size="40" id="file_pre"/>&nbsp;
<select name="table" onchange="if(this.value)$('file_pre').value=this.value;">
<option value="">选择备份文件系列</option>
<?php echo $sql_select;?>
</select><br/><span id="dfile_pre" class="f_red"></span>
</td>
</tr>
<tr>
