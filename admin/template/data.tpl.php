...
<td>
<a href="?file=<?php echo $file;?>&action=import&name=<?php echo $v['name'];?>" onclick="return confirm('确定要导入此配置文件吗？\n\n此操作不可恢复，请在导入前备份相关的数据表');"><img src="<?php echo IMG_PATH;?>import.png" width="16" height="16" title="导入本系列配置文件" alt=""/></a>&nbsp;
<a href="?file=<?php echo $file;?>&action=view&name=<?php echo $v['name'];?>"><img src="<?php echo IMG_PATH;?>view.png" width="16" height="16" title="效果预览" alt=""/></a>&nbsp;
<a href="?file=<?php echo $file;?>&action=config&name=<?php echo $v['name'];?>"><img src="<?php echo IMG_PATH;?>edit.png" width="16" height="16" title="修改" alt=""/></a>&nbsp;
<a href="?file=<?php echo $file;?>&action=download&name=<?php echo $v['name'];?>"><img src="<?php echo IMG_PATH;?>save.png" width="16" height="16" title="下载" alt=""/></a>&nbsp;
<a href="?file=<?php echo $file;?>&action=delete&name=<?php echo $v['name'];?>" onclick="return _delete();"><img src="<?php echo IMG_PATH;?>delete.png" width="16" height="16" title="删除" alt=""/></a></td>
</tr>
<?php }?>
</table>
